      ...
      begin
        ...
        when 'Начать заработать💰'
          earn_keyboard = Telegram::Bot::Types::ReplyKeyboardMarkup.new(
            keyboard: [
              [Telegram::Bot::Types::KeyboardButton.new(text: 'С Ютуба❤️')],
              [Telegram::Bot::Types::KeyboardButton.new(text: 'С Тик Тока🖤')],
              [Telegram::Bot::Types::KeyboardButton.new(text: 'Другое😜')],
              [Telegram::Bot::Types::KeyboardButton.new(text: 'Назад')]
            ],
            resize_keyboard: true,
            one_time_keyboard: false
          )
          send_message_in_thread(bot, message.chat.id, "Откуда вы узнали про нас?", earn_keyboard)

        when 'С Ютуба❤️', 'С Тик Тока🖤'
          earn_keyboard = Telegram::Bot::Types::ReplyKeyboardMarkup.new(
            keyboard: [
